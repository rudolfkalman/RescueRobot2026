...
#ifndef SQUARE_DIFF_DRIVE_WIDGET_HPP_
#define SQUARE_DIFF_DRIVE_WIDGET_HPP_

// 作成した.uiファイル名によって変わる
// xxx.ui -> ui_xxx.h
#include "ui_square_diff_drive.h"
#include <QTimer>
#include <QPaintEvent>
...
#include "ui_square_diff_drive/qt_node_pub_handler.hpp"
#include "ui_square_diff_drive/qt_node_sub_handler.hpp"
#endif
...
// Widgetのクラス
class SquareDiffDriveWidget : public rviz_common::Panel
{
public:
  // 初期化
  explicit SquareDiffDriveWidget(QWidget * parent = nullptr);
...
#endif //SQUARE_DIFF_DRIVE_WIDGET_HPP_
